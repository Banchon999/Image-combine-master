...
Qt workspace มี action bar สำหรับ Import, Import Folder, Export, Undo/Redo และ
Zoom พร้อม properties sidebar และ asset drawer แบบ thumbnail ที่ลากสลับลำดับ
หรือลบภาพได้

### Interactive Workspace

1. กด **Import Folder** เพื่อให้ Smart Order เรียงภาพแบบ natural sort หรือกด
   **Import** เพื่อเลือกหลายไฟล์
2. ตรวจลำดับใน Asset Drawer และลากสลับได้ตามต้องการ
3. ตั้งทิศทาง, format, quality, จำนวนส่วน, ขนาดสูงสุด และ Smart Name pattern
4. กด **Export** ระบบ Smart Check จะตรวจไฟล์เสียและความผิดปกติก่อนเริ่ม
5. งานประมวลผลทำใน background พร้อม progress และปุ่ม Cancel

### Multi-folder Batch

1. เปิดแท็บ **Multi-folder Batch**
2. กด **+ Folder** ทีละรายการ หรือ **+ Subfolders** เพื่อเพิ่มทุกตอนในโฟลเดอร์แม่
3. ลากเรียง queue, เลือกปลายทาง และเลือกการสร้าง output แยกตามชื่อตอน
4. กด **Run all folders** ระบบจะตรวจทุกงานก่อนเริ่มและทำงานต่อแม้บางโฟลเดอร์ล้มเหลว
